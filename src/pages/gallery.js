...
export default class Gallery extends React.Component {
  constructor() {
    ...
    this.state = {
        buku : [
            {
                isbn : 5000,
                judul : "Inception: The Shooting Script",
                penulis : "Christopher Nolan",
                penerbit : "y",
                harga : 29.74,
                cover : "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQzbFBXP7xeb7uKmbK0Oa_L_2CHGvj57BfQ4XLE3AaHUp6Qbc2f"
            },
            {
                isbn : 5000,
                judul : "Interstellar: The Complete Screenplay With Selected",
                penulis : "Christopher Nolan, Jonathan Nolan",
                penerbit : "y",
                harga : 25.00,
                cover : "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcTstI06lw1l5AeLX6J7o__uQDBRAmc0bqyAaatcuuhhSSs8mSXf"
            },
            {
                isbn : 5000,
                judul : "Harvest Moon: Back to Nature",
                penulis : "Natsume",
                penerbit : "Natsume Inc.",
                harga : 37.00,
                cover : "https://drive.google.com/uc?id=1i1Jfw9Qjrlt5Cqv7wKTXa86NRoSaXOzr"
            }
        ],
  ...
  addToCart = (selectedItem) => {
      ...
      if(existItem) window.alert("telah tersedia")
      else {
          let jumlah = window.prompt("jumlah")
